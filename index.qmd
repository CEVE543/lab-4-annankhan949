...
*Through the interative prior process my understanding of Houston rainfall was changed. I knew Houston was subject to plenty of rain and at times extreme rains like Harvey but looking at the RL v RP plots the return period of higher return levels is less that I thought.*

**Response 2: Data Learning and Posterior Insights**
*It made me slightly less reliant on GEV parameters. Using the observed data improved the variablity of the return levels and helped provided a more realistic prediction.*

**Response 3: Two-Station Bayesian Comparison**
*Yes, since we chose one of the five closest stations. This can show the relationship between the similar observed data affecting the priors and that observed data being a factor of environmental variables. We should choose our priors more based on domain knowledge to get as close as station specific as we can.*

**Response 4: Uncertainty Quantification and Model Validation**
*I think Bayesian uncertainty quantification is a little more clear to see through the plots and makes more sense to me than MLE. It also shows that the model is more reliable than MLE.*

**Response 5: Bayesian Workflow for PS1**
*It will help me be able to factor out methods that could lead to poor models and avoid me having to test a bunch out. I anticipate that the syntax and understanding the little things will pose a significant challenge.*
...
Are these return level curves reasonable for Houston's climate, based on your domain knowledge? Not really no, there is a wide range of possible return levels with a lot of extremes
:::
